							...
							<form method="post" encType="multipart/form-data" action="#" id="guardar">
								...
								<Row>
									...
									<Col xs={12} sm={12} md={6} lg={6}>
										...
										<input type="text" className="form-control" required onChange={ e => { this.soloNumeros(e, 15) } } onKeyDown={ e => { this.soloNumeros(e,15) } }  name="telefono_personal" placeholder="Telefono personal" />
									</Col>
									<Col xs={12} sm={12} md={6} lg={6}>
										<label>Telefono de contacto</label>
										<input type="text" className="form-control" required  onChange={ e => { this.soloNumeros(e, 15) } } onKeyDown={ e => { this.soloNumeros(e,15) } }  name="telefono_habitacion" placeholder="Telefono de contacto" />
									</Col>
									<Col xs={12} sm={12} md={6} lg={6}>
