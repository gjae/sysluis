<?php $__env->startSection('titulo', 'Gestion de facturación'); ?>

<?php $__env->startSection('css'); ?>

<link rel="stylesheet" href="<?php echo e(asset('css/facturacion.css')); ?>">
...
<div class="container" id="formulario_facturas">
	<div class="row">
		<div class="col-sm-8 col-md-8">	
			...
			<form  method="post" id="facturacion" action="<?php echo e(url('dashboard/facturacion/factura')); ?>">
...
<script src="<?php echo e(asset('js/modulo_factura.js')); ?>"></script>
<?php $__env->stopSection(); ?>
</div>
